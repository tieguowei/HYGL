...
<div class="panel panel-default">
	<div class="panel-body">
		<form id="dept_conForm" class=" form-inline" style="margin-bottom: 0;">
...
<!-- 模态框（Modal） -->
<!-- 添加部门 -->
<div id="dept_addDlg"  class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true" style="width: 600px;" >
    <div class="modal-content">
			...
			<form class="form-horizontal bv-form"   id="addDeptForm"  method="post" style="margin-top: 15px;">
				...
				<div class="form-group">
					<label class="col-md-4 control-label">一级部门：</label>
				...
				<div class="form-group">
					<label class="col-md-4 control-label">部门排序：</label>
					<div class="col-md-6" class="form-control form-control-static">
...
<!-- 修改 -->
<div id="dept_updateDlg" class="modal fade"  tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true" style="width: 600px;" >
    <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            ...
            <div class="modal-body" style="height: 300px;">
			<form class="form-horizontal bv-form" id="updateDeptForm"  method="post" style="margin-top: 15px;">
