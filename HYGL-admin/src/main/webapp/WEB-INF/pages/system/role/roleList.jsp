...
<body>
<!--toolbar  -->
<div id="roleToolbar" class="btn-toolbar">
...
<div id="roleAddDlg" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form class="form-horizontal bv-form" id="addRoleForm"  method="post" style="margin-top: 15px;">
			...
			<div class="form-group">
				<label class="col-md-4 control-label">角色编码：</label>
				<div class="col-md-6 ">
...
<div id="roleMydlg" class="modal fade"  tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="container">
			<form class="form-horizontal bv-form" id="updateRoleForm"  method="post" style="margin-top: 15px;">
			<div class="form-group">
				<div class="col-md-3 ">
...
<!-- 模态框（Modal） -->
<!-- 权限-->
<div id="roleAuthDlg" class="modal fade"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" 
aria-hidden="true" style=" width: 600px;top:0;">
    <div class="modal-dialog" style="width:100%;">
		<div class="modal-content" style="width:100%;">
			...
			<form class="form-horizontal   bv-form" id="authForm"  method="post" style="margin-top: 15px;">
				<div class="form-group">
