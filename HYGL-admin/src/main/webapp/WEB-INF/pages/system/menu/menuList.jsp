...
<!--toolbar  -->
<div id="menuToolbar" class="btn-toolbar" 360chrome_form_autofill="2">
<shiro:hasPermission name="menuManager:add">
		<button type="button" class=" btn btn-info" onclick="Menu.addMenu()" 360chrome_form_autofill="2">
...
<div id="menuAddDlg" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true"  >
    <div class="modal-dialog" style="width:100%;">
        <div class="modal-content">
			...
			<form class="form-horizontal bv-form" id="addMenuForm"  method="post" style="margin-top: 15px;">
				...
				<div class="form-group">
					<label class="col-md-4 control-label">菜单类型：</label>
					<div class="col-md-6">
				...
				<div class="form-group">
					<label class="col-md-4 control-label">权限标识：</label>
					<div class="col-md-6">
				...
				<div class="form-group">
					<label class="col-md-4 control-label">一级菜单：</label>
				...
				<div class="form-group"style="z-index: 0" >
					<label class="col-md-4 control-label">图标样式：</label>
					<div class="col-md-6">
				...
				<div class="form-group"style="z-index: 0">
					<label class="col-md-4 control-label">菜单描述：</label>
					<div class="col-md-6">
...
<div id="menuUpdateDlg" class="modal fade"  tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="width:100%;">
        <div class="modal-content">
            ...
            <div class="modal-body" style="height: 400px; overflow-y:scroll;"> 
			<form class="form-horizontal bv-form"  id="updateMenuForm"  method="post" style="margin-top: 15px;">
				<div class="form-group" >
					<label class="col-md-4 control-label">菜单名称：</label>
					<div class="col-md-6 ">
