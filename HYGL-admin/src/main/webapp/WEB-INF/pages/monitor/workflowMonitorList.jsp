		...
		<form id="emplpyeeConForm" class=" form-inline" style="margin-bottom: 0;">
		  ...
		  <div class="form-group">
		   <label for="disabledSelect"  class="col-sm-4 control-label">流程类型：</label>
		    <div class="col-md-2 ">
		    <select class="form-control form-control-static" id="monitor_search_process_type">
		   ...
		   <label for="disabledSelect"  class="col-sm-4 control-label">运行状态：</label>
		    <div class="col-md-2 ">
		    <select  class="form-control form-control-static" id="monitor_search_run_status">
                        <option value="">请选择</option>
             </select>
		    </div>
		  </div>
...
<!--toolbar  -->
	<div id="monitorWorkflowToolbar" class="btn-toolbar" style="margin-top: 15px;">
	   		<button type="button" class="btn btn-info" onclick="ProcessConfigMonitor.manualMultipleStart()">
	   			 <span class="glyphicon glyphicon-plus" >手动启动</span>
	   		 </button>
	  		<button class=" btn btn-danger" type="button" onclick="ProcessConfigMonitor.manualMultipleStop()">
	  			<span class="glyphicon glyphicon-remove" >手动停止</span>
	  		</button>
	</div>
<!--列表 -->
<table id="ProcessConfigMonitor-table" class="text-nowrap table table-condensed table-hover table-bordered" style='table-layout:fixed;'></table>
</body>
</html>