    ...
    return{
        ...
        // 修改 --》 初始起止作业：展示上一关联作业
          ...
          cancelUpdateProcess:function(menuId){
        	  var processId = $("#global_process_id").val();
        	  var ids = $("#relationIds").val();
        	  //删除新添加的子节点
        	  $.ajax({
	                url:'workflow/deleteJobRelation',
	                dataType:'json',
	                type:'post',
	                data:{"ids":ids,"processId":processId},
	                success:function(data){
	                	 closeTab(888);
	                	 createUpdateProcessTab(menuId);
	                }
