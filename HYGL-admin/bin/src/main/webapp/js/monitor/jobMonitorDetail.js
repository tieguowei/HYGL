...
var JobMonitorDetail = function (){
    return{
        ...
        showJobHistorySketch:function(){
        	...
        	if(jobHistorySketch != '' && jobHistorySketch != 'undefined'){
        ...
        showJobHistoryUrl:function(){
        	...
        	if(jobHistoryUrl != '' && jobHistoryUrl != 'undefined'){
        		alert(jobHistoryUrl)
        	}
        },
        // 返回操作
...
function createJobMonitorListTab(menuId){
	...
	clickTab(menuId,"monitor/toJobMonitorPage?id="+processId+"&version="+version);
