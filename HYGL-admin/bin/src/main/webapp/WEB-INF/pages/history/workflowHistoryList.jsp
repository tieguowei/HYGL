	...
	<div class="panel-body">
		<form id="emplpyeeConForm" class=" form-inline">
		  <div class="form-group">
		   	 <input style="width: 180px;" type="text" class="form-control" id="search_process_name" name="processName" placeholder="请输入流程名称">
		     流程类型：
		    <select  style="width: 190px;" class="form-control form-control-static" id="search_process_type" name="processType">
		...
		<button type="button" onclick="ProcessHistory.searchProcessHistory()" class="btn btn-info ">
   		...
   		<button type="button" onclick="ProcessHistory.empty()" class="btn btn-danger ">
...
<div style="overflow:scroll;">
	<table id="ProcessHistory-table" class="table table-hover table-striped table-condensed table-bordered" style="min-width:1600px;"></table>
</div>
</body>
</html>